...
ENV_VARS_CHATWORK="USE_BRAIN_ARCHITECTURE=true,ENVIRONMENT=production,LOG_EXECUTION_ID=true,ENABLE_MEETING_TRANSCRIPTION=true,ENABLE_MEETING_MINUTES=true,MEETING_GCS_BUCKET=soulkun-meeting-recordings,TELEGRAM_CEO_CHAT_ID=8304510694,TELEGRAM_BOT_USERNAME=soulsyncs_bot"
