...
│ 1. コード実装完了                                            │
│     ↓                                                       │
│ 2. git commit（バージョン番号をコミットメッセージに含める）    │
│     ↓                                                       │
...
│                    進捗報告フェーズ（必須）                   │
├─────────────────────────────────────────────────────────────┤
│ 11. CLAUDE.mdの「直近の主な成果」セクションを更新            │
│     ↓                                                       │
│ 12. バージョン番号・PR番号・変更内容を記録                   │
│     ↓                                                       │
│ 13. 「最終更新」日付を更新                                   │
│     ↓                                                       │
│ 14. ユーザーに完了報告（全フロー完了を明示）                  │
└─────────────────────────────────────────────────────────────┘
```

**重要事項**:
- ステップ1〜7は自動で進めること
- ステップ8でユーザーの最終確認を必ず取ること（マージ前の確認）
- ステップ9〜14はユーザー承認後に連続して実行すること
- **ステップ11〜13（進捗報告）は絶対にスキップしないこと**
- ステップ14で「全フロー完了」を明示的に報告すること
