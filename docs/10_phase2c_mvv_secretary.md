...
| 項目 | 内容 |
|------|------|
| **この文書の役割** | Phase 2C（MVV・アチーブ連携、ベテラン秘書機能）の設計書 |
| **書くこと** | Phase 2Cの目的、機能概要、設計原則との整合性 |
| **書かないこと** | 組織論の詳細（→11章）、System Prompt（→25章） |
| **SoT（この文書が正）** | Phase 2Cのスコープ、機能定義 |
| **Owner** | Tech Lead |
| **更新トリガー** | Phase 2Cの仕様変更時 |
