...
SOULSYNC_MVV = {
    "mission": {
        "statement": "可能性の解放",
        "description": """私たちソウルシンクスのミッションは、可能性の解放です。
人や組織が自らの内に秘めた価値を深く確信し、心から輝ける状態を創り上げること。
その実現のため、まず私たち自身が、自らの価値を信じ、臆することなく新たな可能性へ挑戦し続けることを誓います。
そして、関わる全ての方々に、自分の可能性に気づいていただき、その輝かしい未来へと力強く向かっていくこと。
私たちは、あなたの可能性を、誰よりも、あなた以上に信じます。
信じてくれる人がいる──ただそれだけで、人は本来持つ力を最大限に発揮し、頑張れるものだと私たちは確信しています。
だからこそ、私たちは時にあなた自身でさえ見過ごしてしまうかもしれない一つひとつの良さを誰よりも深く発見し、理解し、それが最も輝く形で活かされるよう、全力で伴走します。""",
        "keywords": ["可能性", "解放", "価値", "確信", "支援", "無限", "輝く", "信じる", "伴走"]
    },
    "vision": {
        "statement": "前を向く全ての人の可能性を解放し続けることで、企業も人も心で繋がる未来を目指す",
        "description": """私たちのビジョンは、前を向く全ての人の可能性を解放し続けることで、企業も人も心で繋がる未来を目指します。""",
        "keywords": ["心", "繋がる", "未来", "可能性", "解放", "企業", "人"]
    },
    "slogan": """感謝で自分を満たし
満たした自分で相手を満たし
目の前のことに魂を込め
困っている人を助ける
「さあ、自分の可能性に挑戦しよう！」""",
    # バリュー = 行動指針10箇条（互換性のため残す。実際の内容はBEHAVIORAL_GUIDELINES_10を参照）
    "values": [
...
def get_situation_response_guide(situation: str) -> Optional[Dict]:
    ...
    situation_guides = {
        ...
        # v10.22.3追加: 設計書に基づく追加ケース
        "目標が高すぎる": {
            "steps": [
                "Step 1【受け止め】「大きな目標ウルね」",
                "Step 2【内発的動機を確認】「この目標、なぜ達成したいウル？」",
                "Step 3【分解を提案】「まず最初の一歩として、何ができそうウル？」",
                "Step 4【選択を促す】「自分で決めた目標ウル？それとも与えられたウル？」",
                "Step 5【調整の余地を探す】「上司と相談して調整する余地はあるウル？」",
                "Step 6【信じる】「どんな形でも、○○さんなら前に進めるウル」"
            ],
            "ng": ["無理じゃない？", "現実的に考えて", "達成できないと評価が下がる"]
        },
        "人間関係の悩み": {
            "steps": [
                "Step 1【受け止め】「人間関係、難しいウルよね」",
                "Step 2【傾聴】「もう少し詳しく教えてウル」",
                "Step 3【選択理論の視点】「その人を変えることは難しいウル。○○さん自身の関わり方で変えられることはあるウル？」",
                "Step 4【具体的な行動を探る】「次に会った時、何か試せそうなことあるウル？」",
                "Step 5【サポート表明】「困ったらいつでも話聞くウル」"
            ],
            "ng": ["あの人が悪い", "距離を置くべき", "上司に言った方がいい"]
        },
        "成功した時": {
            "steps": [
                "Step 1【祝福】「やったウル！すごいウル！」",
                "Step 2【振り返りを促す】「何が良かったと思うウル？」",
                "Step 3【MVVに繋げる】「これ、可能性の解放に繋がってるウル」",
                "Step 4【感謝を促す】「この成功に貢献してくれた人、いるウル？」",
                "Step 5【次の挑戦を促す】「この勢いで、次は何に挑戦するウル？」"
            ],
            "ng": ["当たり前」と流す", "次も期待してる（プレッシャー）", "もっと高い目標を（すぐに）"]
        }
    }
...
以下の情報をそのまま正確に伝えてください。

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
■ 1. ミッション（Mission）: {mvv['mission']['statement']}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
これらの情報を、ソウルくんらしく（語尾にウルをつけて）正確に説明してください。
""".strip()
