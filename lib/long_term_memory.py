...
# 長期記憶を示すパターン
# v10.41.0: パターン拡張 - 「人生軸」（の無し）、プロフィール保存要求等を追加
LONG_TERM_MEMORY_PATTERNS = [
    # 人生の軸・WHY（「の」をオプショナル化）
    r"人生の?(軸|why|ワイ)",
    r"人生軸",  # 明示的に追加（「の」無しでも確実にマッチ）
    r"生き方としての",
    r"存在意義",
    r"生きる(目的|理由|意味)",
    r"俺の軸",
    ...
    # v10.41.0: プロフィール・長期記憶保存の明示的要求
    r"プロフィール(に|の|へ)(保存|記憶|メモ)",
    r"長期記憶(に|として|へ)(保存|覚えて)",
    r"(WHY|ホワイ|ワイ)を.*(覚えて|保存)",
    r"長期(で|に|として)覚えて",
]
